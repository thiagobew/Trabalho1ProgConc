...
void globals_set_seats_per_table(int number) { seats_per_table = number; }

int globals_get_number_of_buffets() { return number_of_buffets; }

int globals_get_seats_per_table() { return seats_per_table; }
...
void globals_set_buffets(buffet_t *buffets) { buffets_ref = buffets; }

buffet_t *globals_get_buffets() { return buffets_ref; }
